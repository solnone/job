...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '23988bcd-55db-4bd1-97ee-fa3593c6bb51' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('aec3715a-2ddb-4cb6-a1cf-7018e629bab3');
      cy.get(`[data-cy="name"]`).should('have.value', 'aec3715a-2ddb-4cb6-a1cf-7018e629bab3');
