...
/**
 * Criteria class for the {@link io.solnone.job.domain.Task} entity. This class is used
 * in {@link io.solnone.job.web.rest.TaskResource} to receive all the possible filtering options from
