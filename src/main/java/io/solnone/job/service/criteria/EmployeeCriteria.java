...
/**
 * Criteria class for the {@link io.solnone.job.domain.Employee} entity. This class is used
 * in {@link io.solnone.job.web.rest.EmployeeResource} to receive all the possible filtering options from
