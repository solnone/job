...
/**
 * Criteria class for the {@link io.solnone.job.domain.Country} entity. This class is used
 * in {@link io.solnone.job.web.rest.CountryResource} to receive all the possible filtering options from
