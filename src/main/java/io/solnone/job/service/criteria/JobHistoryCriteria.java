...
/**
 * Criteria class for the {@link io.solnone.job.domain.JobHistory} entity. This class is used
 * in {@link io.solnone.job.web.rest.JobHistoryResource} to receive all the possible filtering options from
