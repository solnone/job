  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jobApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="jobApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jobApp.location.streetAddress')}
                id="location-streetAddress"
                name="streetAddress"
                data-cy="streetAddress"
                type="text"
              />
              <UncontrolledTooltip target="streetAddressLabel">
                <Translate contentKey="jobApp.location.help.streetAddress" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jobApp.location.postalCode')}
              ...
              <ValidatedField label={translate('jobApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <UncontrolledTooltip target="cityLabel">
                <Translate contentKey="jobApp.location.help.city" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jobApp.location.stateProvince')}
                id="location-stateProvince"
                name="stateProvince"
                data-cy="stateProvince"
                type="text"
              />
              <UncontrolledTooltip target="stateProvinceLabel">
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jobApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
