  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jobApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="jobApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jobApp.country.countryName')}
                id="country-countryName"
                name="countryName"
                data-cy="countryName"
                type="text"
              />
              <UncontrolledTooltip target="countryNameLabel">
                <Translate contentKey="jobApp.country.help.countryName" />
              </UncontrolledTooltip>
              <ValidatedField id="country-region" name="region" data-cy="region" label={translate('jobApp.country.region')} type="select">
                <option value="" key="0" />
                {regions
