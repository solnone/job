    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countryDetailsHeading">
          <Translate contentKey="jobApp.country.detail.title">Country</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            ...
            <UncontrolledTooltip target="countryName">
              <Translate contentKey="jobApp.country.help.countryName" />
            </UncontrolledTooltip>
          </dt>
          <dd>{countryEntity.countryName}</dd>
          <dt>
            <Translate contentKey="jobApp.country.region">Region</Translate>
          </dt>
