  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jobApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="jobApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jobApp.department.departmentName')}
              ...
              />
              <UncontrolledTooltip target="departmentNameLabel">
                <Translate contentKey="jobApp.department.help.departmentName" />
              </UncontrolledTooltip>
              <ValidatedField
                id="department-location"
                name="location"
                data-cy="location"
                label={translate('jobApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
