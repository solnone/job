    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="jobApp.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            ...
            <UncontrolledTooltip target="departmentName">
              <Translate contentKey="jobApp.department.help.departmentName" />
            </UncontrolledTooltip>
          </dt>
          <dd>{departmentEntity.departmentName}</dd>
          <dt>
            <Translate contentKey="jobApp.department.location">Location</Translate>
          </dt>
