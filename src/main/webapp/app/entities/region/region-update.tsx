  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jobApp.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="jobApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jobApp.region.regionName')}
                id="region-regionName"
                name="regionName"
                data-cy="regionName"
                type="text"
              />
              <UncontrolledTooltip target="regionNameLabel">
                <Translate contentKey="jobApp.region.help.regionName" />
              </UncontrolledTooltip>
